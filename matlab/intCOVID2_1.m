...
d=[0.01 0.2]; % daily proportion diagnosed (initially and after start of intervention)
...
sd=0.5; %maximum reduction of transmission due to social distancing
de=[60 81]; % period of implementing social distancing
