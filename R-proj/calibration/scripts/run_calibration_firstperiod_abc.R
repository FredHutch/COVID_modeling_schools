...
# more recently for firstperiod 600000 => 90 hrs
...
abc_rej = ABC_rejection(model = retry_wrapper,
                        ...
                        verbose = TRUE,
                        progress_bar = TRUE)
save(abc_rej, file = "out_firstperiod_again_rej.rdata")

# abc_seq = ABC_sequential(method = "Beaumont", # Drovandi Delmoral Lenormand
#                         model = retry_wrapper,
#                         prior = params_priors,
#                         nb_simul =  1000, #10000,
#                         summary_stat_target = summary_stats_abc,
...
#                         verbose = TRUE,
#                         progress_bar = TRUE)
# save(abc_seq, file = "out_firstperiod_seq.rdata")
