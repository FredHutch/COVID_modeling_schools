...
data_means = list( pmax( apply(data_abc[,paste0("pos", 1:4)], 2, mean), rep(1, 4)),
...
summary_stats_abc = calc_data_stats(data_abc, dates_abc, data_means, stats_to_include = c("hosp"))
