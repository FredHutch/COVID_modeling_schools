...
source("calibration/functions/constraints.R")
...
params_priors = list(
  ...
  sd_1 = c("unif", 0.05, 0.7),
  sd_2 = c("unif", 0.05, 0.7), 
  sd_3 = c("unif", 0.05, 0.7), 
  sd_4 = c("unif", 0.05, 0.7), 
  ...
  `t-2020.05.31-sd_1` = c("unif", 0.05, 0.7),
  `t-2020.05.31-sd_2` = c("unif", 0.05, 0.7),
  `t-2020.05.31-sd_3` = c("unif", 0.05, 0.7),
  `t-2020.05.31-sd_4` = c("unif", 0.05, 0.7),
  `t-2020.07.19-sd_1` = c("unif", 0.05, 0.7),
  `t-2020.07.19-sd_2` = c("unif", 0.05, 0.7),
  `t-2020.07.19-sd_3` = c("unif", 0.05, 0.7),
  `t-2020.07.19-sd_4` = c("unif", 0.05, 0.7),
  `t-2020.09.06-sd_1` = c("unif", 0.05, 0.7),
  `t-2020.09.06-sd_2` = c("unif", 0.05, 0.7),
  `t-2020.09.06-sd_3` = c("unif", 0.05, 0.7),
  `t-2020.09.06-sd_4` = c("unif", 0.05, 0.7),
  `t-2020.11.01-sd_1` = c("unif", 0.05, 0.7),
  `t-2020.11.01-sd_2` = c("unif", 0.05, 0.7),
  `t-2020.11.01-sd_3` = c("unif", 0.05, 0.7),
  `t-2020.11.01-sd_4` = c("unif", 0.05, 0.7),
  `t-2020.11.15-sd_1` = c("unif", 0.05, 0.7),
  `t-2020.11.15-sd_2` = c("unif", 0.05, 0.7),
  `t-2020.11.15-sd_3` = c("unif", 0.05, 0.7),
  `t-2020.11.15-sd_4` = c("unif", 0.05, 0.7)
)

abc_param_names = names(params_priors)

# need to extract sd parameters, then construct chain so that SD1 > SD2 & SD2 < SD3 & SD3 > SD4 etc.
constaints = c(">", "<", ">", ">", "<")
param_constraint = generate_sd_constraints(abc_param_names, constaints)
